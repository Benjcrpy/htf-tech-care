    ...
    <div className='bg-white w-full py-16 text-white'>
        <div className='max-w-[1240px] mx-auto grid lg:grid-cols-3'>
            <div className='lg:col-span-2 my-4'>
                <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2 text-slate-500'>Lorem ipsum dolor sit.</h1>
            ...
            <div className='my-4 gap-2'>
                ...
                <p className='text-slate-500'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Autem neque voluptates, doloribus repudiandae rem voluptate</p>
            </div>
        </div>
    </div>
  )
